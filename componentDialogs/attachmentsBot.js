...
class AttachmentsBot extends ActivityHandler {
     ...
     */
    getInlineAttachment() {
        const imageData = fs.readFileSync(path.join(__dirname, '../images/pizzas/brocolis/pizza-de-brocolis.jpg'));
        const base64Image = Buffer.from(imageData).toString('base64');

        return {
            name: 'pizza-de-brocolis.jpg',
    ...
    getInternetAttachment() {
        ...
        return {
            name: 'pizza-de-brocolis.jpg',
            contentType: 'image/jpeg',
            contentUrl: 'https://docs.microsoft.com/en-us/bot-framework/media/how-it-works/pizza-de-brocolis.jpg'
        };
    }
